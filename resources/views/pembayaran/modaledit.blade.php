    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Ubah Bukti Bayar</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body px-5 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_user_form" class="form" method="POST" action="{{ route('pembayaran-edit') }}"
    ...
    function getdata(id) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('.image-input-wrapper').css('background-image', 'url(' + file + ')');
