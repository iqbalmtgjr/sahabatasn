                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <div>
                                                    <select class="form-select form-select-solid select2-hidden-accessible"
                                                        ...
                                                        data-dropdown-parent="#kt_menu_64b77f26c5904"
                                                        data-allow-clear="true" data-select2-id="select2-data-17-ho3y"
                                                        ...
                                                        style="width: 100%;"><span class="selection"><span
                                                                ...
                                                                <ul class="select2-selection__rendered"
                                                                    ...
                                                                    <textarea class="select2-search__field" type="search" tabindex="0" autocorrect="off" autocapitalize="none"
                                                                        ...
                                                                        aria-describedby="select2-ni7c-container" placeholder="Select option" style="width: 100%;"></textarea>
                                                                </span>
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <br>to approve newly amended policies</p> --}}
                                    <a href="{{ url('kerjakan') }}" class="btn btn-primary w-100 py-3">Kerjakan</a>
                                </div>
                            </div>
                            <!--end::Body-->
                        </div>
