        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 my-7">
                ...
                <form id="kt_modal_add_user_form" class="form" method="POST"
                    action="{{ url('/tryout-gratis/update') }}" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Scroll-->
...
<script>
    function getdata(id) {
        // console.log(id)
        var url = '{{ url('/tryout-gratis/getdata') }}' + '/' + id
        // console.log(url);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#pilihan_a').val(response.jawabangratis.pilihan_a);
                $('#pilihan_b').val(response.jawabangratis.pilihan_b);
                $('#pilihan_c').val(response.jawabangratis.pilihan_c);
                $('#pilihan_d').val(response.jawabangratis.pilihan_d);
                $('#pilihan_e').val(response.jawabangratis.pilihan_e);
                $('#jawaban_a').val(response.jawabangratis.jawaban_a);
                $('#jawaban_b').val(response.jawabangratis.jawaban_b);
                $('#jawaban_c').val(response.jawabangratis.jawaban_c);
                $('#jawaban_d').val(response.jawabangratis.jawaban_d);
                $('#jawaban_e').val(response.jawabangratis.jawaban_e);
            }
        });
    }
</script>
