                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" name="soal"
                                        ...
                                        placeholder="Masukkan soal" value="" />
                                    @error('soal')
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select class="form-control form-control-solid mb-3 mb-lg-0" name="kategori"
                                        id="">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="pilihan_a"
                                                ...
                                                placeholder="Masukkan pilihan A" value="" />
                                            @error('pilihan_a')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control form-control-solid mb-3 mb-lg-0" name="">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" name="pilihan_b"
                                        ...
                                        placeholder="Masukkan pilihan B" value="" />
                                    @error('pilihan_b')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" name="pilihan_c"
                                        ...
                                        placeholder="Masukkan pilihan C" value="" />
                                    @error('pilihan_c')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" name="pilihan_d"
                                        ...
                                        placeholder="Masukkan pilihan D" value="" />
                                    @error('pilihan_d')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" name="pilihan_e"
                                        ...
                                        placeholder="Masukkan pilihan E" value="" />
                                    @error('pilihan_e')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="fv-row mb-7">
                                ...
                                {{-- <input type="text" name="soal"
                                    class="form-control form-control-solid mb-3 mb-lg-0 @error('soal') is-invalid @enderror"
                                    placeholder="Masukkan soal" value="" /> --}}
                                <textarea class="form-control form-control-solid mb-3 mb-lg-0" name="" id="" cols="30"
                                    rows="10"></textarea>
                                @error('soal')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
